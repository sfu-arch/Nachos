...
cl::opt<bool> UseBasicAAOnly("only-basic-aa", cl::desc("Use only basic AA for Stage 1"), cl::init(false));
...
int main(int argc, char **argv, const char **env) {
    ...
    // ADD A PASS HERE - Similar to AliasEdgeWriter on the Sequence of Basic Blocks
    // used to create extracted function
