...
all_knobs_c::all_knobs_c() {
  ...
  // ===========  ===========
  KNOB_MEM_CONTEXT_SWITCH_ENABLE = new KnobTemplate< bool > ("mem_context_switch_enable", false);
	...
	KNOB_CLOCK_ACC = new KnobTemplate< float > ("clock_acc", 1.0);
	

	// =========== ../def/memory.param.def ===========
	KNOB_PERFECT_ICACHE = new KnobTemplate< bool > ("perfect_icache", true);
	...
	KNOB_ICACHE_BY_PASS = new KnobTemplate< bool > ("icache_by_pass", true);
	...
	KNOB_MEM_MEDIUM_MSHR_SIZE = new KnobTemplate< int > ("mem_medium_mshr_size", 128);
	...
	KNOB_RUBY_NUM_BANKS = new KnobTemplate< uns32 > ("ruby_num_banks", 4);
	KNOB_RUBY_NUM_DIR = new KnobTemplate< uns32 > ("ruby_num_dir", 1);
	KNOB_PERFECT_STACK = new KnobTemplate< bool > ("perfect_stack", false);
	KNOB_STACK_MASK = new KnobTemplate<uns32 > ("stack_mask", 0X00000000);
...
all_knobs_c::~all_knobs_c() {
	...
	delete KNOB_MEM_MEDIUM_MSHR_SIZE;
	...
	delete KNOB_RUBY_NUM_BANKS;
	delete KNOB_RUBY_NUM_DIR;
	delete KNOB_PERFECT_STACK;
    delete KNOB_STACK_MASK; 
  ...
  delete KNOB_MEM_CONTEXT_SWITCH_ENABLE;
}
...
void all_knobs_c::registerKnobs(KnobsContainer *container) {
	...
	container->insertKnob( KNOB_CLOCK_ACC );
	...
	container->insertKnob( KNOB_MEM_MEDIUM_MSHR_SIZE );
	...
	container->insertKnob( KNOB_RUBY_NUM_BANKS );
	container->insertKnob( KNOB_RUBY_NUM_DIR );
	container->insertKnob( KNOB_PERFECT_STACK );
	container->insertKnob( KNOB_STACK_MASK );
  ...
  // =========== 
  container->insertKnob( KNOB_MEM_CONTEXT_SWITCH_ENABLE );
}
