...
class LSB_CountingBloomFilter_1 : public AbstractBloomFilter {
public:

  ~LSB_CountingBloomFilter_1();
  LSB_CountingBloomFilter_1(string config, bool ishash2);
