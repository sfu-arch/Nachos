...
class all_knobs_c {
	...
	// =========== ../def/general.param.def ===========
		...
		KnobTemplate< float >* KNOB_CLOCK_ACC;
	...
	// =========== ../def/memory.param.def ===========
		...
		KnobTemplate< int >* KNOB_MEM_MEDIUM_MSHR_SIZE;
		...
		KnobTemplate< uns32 >* KNOB_RUBY_NUM_BANKS;
		KnobTemplate< uns32 >* KNOB_RUBY_NUM_DIR;
		KnobTemplate< bool >* KNOB_PERFECT_STACK;
		KnobTemplate< uns32 >* KNOB_STACK_MASK;
    ...
    KnobTemplate< bool >* KNOB_MEM_CONTEXT_SWITCH_ENABLE; 
